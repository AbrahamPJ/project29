...
function setup(){
    ...
    box1 = new Box(605,0,20,20);
    box2 = new Box(610,0,20,20);
    box3 = new Box(615,0,20,20);
    box4 = new Box(620,0,20,20);
    box5 = new Box(620,0,20,20);
    box6 = new Box(625,0,20,20);
    box7 = new Box(1005,0,20,20);
    box8 = new Box(1010,0,20,20);
    box9 = new Box(1015,0,20,20);
    box10 = new Box(1020,0,20,20);
    box11 = new Box(1025,0,20,20);
